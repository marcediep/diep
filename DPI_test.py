...
def get_name(code=""):
    ...
    URL = f"{URL_BASE}/{PATH}"
    headers = {"Content-Type":"application/json", 
            "authorization": f"Bearer {'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ0b2tlbiIsImF1ZCI6IjUyNWU5YWE4LWQxZjUtNDZjNy1hMjU4LTI3NzliMzNlNzQzOCIsInByZHRfY2QiOiIiLCJpc3MiOiJ1bm9ndyIsImV4cCI6MTcxNDcxNzc0OSwiaWF0IjoxNzE0NjMxMzQ5LCJqdGkiOiJQU203M1JYdTk5R2dwdExuN2RPQk5WS1RCRExBRUx6THZYMEQifQ.NIVbMobEJkWY3ymnuosX2GeG3QaVtEoaqzSzEW_s9ytgdJt20NEHW0XMVUVecmQowGA2GDajNZ9zRyEEZfOckQ'}",
            "appKey":APP_KEY,
            "appSecret":APP_SECRET,
            "tr_id":"CTPF1002R",
            "custtype":"P"
