...
def get_name(code=""):
    ...
    URL = f"{URL_BASE}/{PATH}"
    headers = {"Content-Type":"application/json", 
            "authorization": f"Bearer {'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ0b2tlbiIsImF1ZCI6ImIwY2M0N2U1LTQ0OGQtNGVjNS1iMmZkLWJlMmFjYzBmODc4OSIsInByZHRfY2QiOiIiLCJpc3MiOiJ1bm9ndyIsImV4cCI6MTcxNDYzNDYzMiwiaWF0IjoxNzE0NTQ4MjMyLCJqdGkiOiJQU203M1JYdTk5R2dwdExuN2RPQk5WS1RCRExBRUx6THZYMEQifQ.9IRfSsPl8ycrodgxz9Fsot0G_gpfkfUCpZLZHTc9pDQPg14XIjcUEnkmPJ-I6mp00vkFnukprQuTWdNcjmOCxw'}",
            "appKey":APP_KEY,
            "appSecret":APP_SECRET,
            "tr_id":"CTPF1002R",
            "custtype":"P"
...
def daily_price(code=""):
    ...
    for i in range (1,3):
        ...
        today1 = today2 - datetime.timedelta(days=2)
...
try:
    ...
    while True :       
        ...
        t_exit = t_now.replace(hour=23, minute=0, second=0, microsecond=0)
        t_sell = t_now.replace(hour=9, minute=0, second=0, microsecond=0)
